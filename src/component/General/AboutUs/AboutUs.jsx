...
import image3 from '../../../assets/Soft-skills.gif';
import image4 from '../../../assets/Soft-skills.gif';
import image5 from '../../../assets/Soft-skills.gif';
...
const AboutUs = () => {
  return (
    <div className="about-us-container">
     ...
     <h1>Welcome to Local Skills Exchange Platform</h1>
      <p>
        In a world where community and collaboration are increasingly important, we are excited to introduce the 
        <strong> Local Skills Exchange Platform</strong>. Our platform is designed to connect individuals within a community who have valuable skills to share with those who need them. Whether you're a seasoned professional or a passionate hobbyist, our platform provides a space for everyone to contribute and benefit from the collective knowledge and expertise of their community.
      </p> 
     </div>
    ...
    <Carousel  showArrows={true} autoPlay={true} infiniteLoop={true}>
      ...
      <h2>How It Works</h2>
      <p>The Local Skills Exchange Platform operates on a simple yet effective model:</p>
      <ol>
      ...
      <h2>Why Choose Us?</h2>
      <ul>
        <li><strong>Community-Centric:</strong> Unlike other platforms, we focus on building and enhancing local communities.</li>
        <li><strong>Inclusive:</strong> Everyone is welcome, regardless of age, background, or skill level.</li>
        <li><strong>Sustainable:</strong> By promoting local skills and resources, we contribute to a sustainable and self-sufficient community model.</li>
        <li><strong>Supportive Environment:</strong> Our community support team is always here to help you navigate the platform and make the most of your experience.</li>
      </ul>

      <h2>Join Us Today</h2>
      <p>
        Whether you're looking to learn a new skill, share your expertise, or simply connect with like-minded individuals in your community, the Local Skills Exchange Platform is the place for you. Join us today and be a part of a vibrant, supportive, and dynamic community where everyone's skills are valued and everyone has something to learn and teach.
      </p>
