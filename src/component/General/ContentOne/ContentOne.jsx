...
const getRandomInterval = () => Math.floor(Math.random() * 2000) + 2000;
  ...
  return (
    <div className="content-one" style={{ backgroundColor: backgroundColor }}>
      <div className="text-content">
        ...
        <h1>
          Versatile App For Locals <br /> Skills and Exchange Platform
        </h1>
        <p>
          Best online platform where members can post the skills
